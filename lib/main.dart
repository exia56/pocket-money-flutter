  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData.from(
        colorScheme: ColorScheme.fromSwatch(accentColor: Colors.pinkAccent),
      ...
      routes: {
        ...
        SingleDayView.route: (context) {
          final DateTime args = ModalRoute.of(context).settings.arguments;
          return SingleDayView(date: args);
        },
        InsertCostView.route: (context) {
          final CostItem args = ModalRoute.of(context).settings.arguments;
